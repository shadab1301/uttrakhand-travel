...
exports.updateDestination = async (req, res, next) => {
  try {
    ...
    if (!DestinationUpdate) { throw new ApiError(400, "Destination is not updated."); }
    return res.status(200).json(new ApiResponse(200, DestinationUpdate, "Data updated successfully."));
