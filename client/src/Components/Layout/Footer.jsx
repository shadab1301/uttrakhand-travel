    ...
    <div className="container">
        <div className="row">
            ...
            <div className="offset-1 col-lg-3 col-md-6 col-sm-12 col-12">
                ...
                <div className="ft-title mt-5 mb-3 wow zoomIn" data-wow-duration="3s">
                    Links
                </div>
                <ul className="links pl-0">
                    <li className=" wow zoomIn" data-wow-duration="3s"><NavLink to="">   Auctor porta</NavLink></li>
            ...
            <div className="col-lg-3 col-md-6 col-sm-12 col-12">
                ...
                <ul className="links pl-0">
                    <li className=" wow zoomIn" data-wow-duration="3s"><NavLink to="">   Metus arcu</NavLink></li>
                    <li className=" wow zoomIn" data-wow-duration="3s"><NavLink to="">  Fringilla convallis</NavLink></li>
                    <li className=" wow zoomIn" data-wow-duration="3s"><NavLink to="">   Condimentum morbi</NavLink></li>
                    <li className=" wow zoomIn" data-wow-duration="3s"><NavLink to="">   Porttitor orci</NavLink></li>
                    <li className=" wow zoomIn" data-wow-duration="3s"><NavLink to="">   Nisi odio</NavLink></li>
                    <li className=" wow zoomIn" data-wow-duration="3s"><NavLink to="">    Vitae proin quam</NavLink></li>
                    <li className=" wow zoomIn" data-wow-duration="3s"><NavLink to="">    Vehicula tincidunt nulla</NavLink></li>
                    <li className=" wow zoomIn" data-wow-duration="3s"><NavLink to="">   Interdum libero consectetur</NavLink></li>
                    <li className=" wow zoomIn" data-wow-duration="3s"><NavLink to="">    Massa vulputate</NavLink></li>
                    <li className=" wow zoomIn" data-wow-duration="3s"><NavLink to="">    Lacus nulla</NavLink></li>
                    <li className=" wow zoomIn" data-wow-duration="3s"><NavLink to="">    Sit lacinia</NavLink></li>
                    <li className=" wow zoomIn" data-wow-duration="3s"><NavLink to="">   Dictum consequat metus</NavLink></li>
                    <li className=" wow zoomIn" data-wow-duration="3s"><NavLink to="">   Mattis vestibulum adipiscing</NavLink></li>
                </ul>
            </div>
